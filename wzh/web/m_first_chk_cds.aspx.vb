...
Partial Class m_first_chk_cds
    ...
    Private Sub JsLoad()
        ...
        sb.AppendLine("    var table = new dbTable(""article"", "".jqPanelTable"", "".jqPanelNumOfPages"", ""m_first_chk_cds"", ""初检的CDs"", 1, """ & CLoginInfo.user_cd & """,""" & CLoginInfo.user_name & """, colsParams,pubInitParams, awaysWhere,500);")
