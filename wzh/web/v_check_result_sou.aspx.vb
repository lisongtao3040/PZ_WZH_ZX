...
Partial Class v_check_result_sou
    ...
    Private Sub JsLoad()
        ...
        sb.AppendLine("    var table = new dbTable(""article"", "".jqPanelTable"", "".jqPanelNumOfPages"", ""v_check_result_sou"", ""检查结果一览"", 1, """ & CLoginInfo.user_cd & """,""" & CLoginInfo.user_name & """, colsParams,pubInitParams, awaysWhere,500);")
