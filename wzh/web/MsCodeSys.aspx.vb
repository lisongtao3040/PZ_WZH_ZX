...
Partial Class MsCodeSys
    ...
    Private Sub JsLoad()
        ...
        sb.AppendLine("    var table = new dbTable(""article"", "".jqPanelTable"", "".jqPanelNumOfPages"", ""m_code_sys"", ""コード体系MS"", 1, """ & CLoginInfo.user_cd & """,""" & CLoginInfo.user_name & """, colsParams, pubInitParams, awaysWhere,500);")
