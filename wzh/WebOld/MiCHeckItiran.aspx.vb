...
Partial Class MiCHeckItiran
    ...
    Private Sub JsLoad()
        ...
        Else
            sb.AppendLine("    var awaysWhere = ""AND line_cd='" & CLoginInfo.line_cd & "'"";")
        End If

        sb.AppendLine("    var table = new dbTable(""article"", "".jqPanelTable"", "".jqPanelNumOfPages"", ""v_mi_check_list"", ""未检查一览"", 1, """ & CLoginInfo.user_cd & """,""" & CLoginInfo.user_name & """, colsParams,pubInitParams, awaysWhere,500);")
