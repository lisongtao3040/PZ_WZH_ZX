...
Public Class t_checkDA
    ...
    '登录新的检查项目
    Public Function CreateNewChkAutoOK(ByVal cd As String, ByVal no As String, ByVal ck_id As String, ByVal user_cd As String, ByVal login_department_cd As String, ByVal line_cd As String, ByVal yotei_chk_date As String) As String
