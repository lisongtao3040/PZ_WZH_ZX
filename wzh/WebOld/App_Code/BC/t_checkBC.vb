...
Public Class t_checkBC
    ...
    Public Function CreateNewChkAutoOK(ByVal cd As String, ByVal no As String, ByVal ck_id As String, ByVal user_cd As String, ByVal department_cd As String, ByVal line_cd As String, ByVal yotei_chk_date As String) As String
        Return DA.CreateNewChkAutoOK(cd, no, ck_id, user_cd, department_cd, line_cd, yotei_chk_date)
    End Function
