...
Partial Class MsCheckMs
    ...
    Private Sub JsLoad()
        ...
        sb.AppendLine("       ,chk_fmt:{IsEmpty_enable:true,width:20}")
        sb.AppendLine("       ,in_1:{IsEmpty_enable:true,width:60}")
        sb.AppendLine("       ,mark:{IsEmpty_enable:true,width:60}")
        ...
        sb.AppendLine("    var table = new dbTable(""article"", "".jqPanelTable"", "".jqPanelNumOfPages"", ""t_check_ms"", ""检查结果明细修正"", 1, """ & CLoginInfo.user_cd & """,""" & CLoginInfo.user_name & """, colsParams,pubInitParams, awaysWhere,500);")
