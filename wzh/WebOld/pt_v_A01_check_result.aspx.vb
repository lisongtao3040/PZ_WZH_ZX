...
Partial Class pt_v_A01_check_result
    ...
    Private Sub JsLoad()
        ...
        Else
            ...
            'sb.AppendLine("    var awaysWhere = "" AND 检查者生产线 in(select line_cd from m_line where department_cd in(" & department_cd & "))"";")
        End If


        sb.AppendLine("setTimeout(function () {")
        'sb.AppendLine("    var table = new dbTable(""article"", "".jqPanelTable"", "".jqPanelNumOfPages"", ""v_A01_check_result"", ""检查结果明细表"", 1, """ & CLoginInfo.user_cd & """,""" & CLoginInfo.user_name & """, colsParams,pubInitParams, awaysWhere,500,false);")
        sb.AppendLine("    var table = new dbTable(""article"", "".jqPanelTable"", "".jqPanelNumOfPages"", ""v_A01_result_list"", ""检查结果明细表"", 1, """ & CLoginInfo.user_cd & """,""" & CLoginInfo.user_name & """, colsParams,pubInitParams, awaysWhere,500,false);")
